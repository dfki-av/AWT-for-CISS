...
MODEL0=checkpoints/step/att_top_25_voc/15-1-voc_MiB_0.pth
...
CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=1 attribute.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 2 --method ${METHOD} --opt_level O2 ${OPTIONS}
...
python3 average_csv.py ${RESULTSFILE} ${TASK}
CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=1 attribute.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 3 --method ${METHOD} --opt_level O2 ${OPTIONS}
...
python3 average_csv.py ${RESULTSFILE} ${TASK}
CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=1 attribute.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 4 --method ${METHOD} --opt_level O2 ${OPTIONS}
...
python3 average_csv.py ${RESULTSFILE} ${TASK}
CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=1 attribute.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 5 --method ${METHOD} --opt_level O2 ${OPTIONS}
