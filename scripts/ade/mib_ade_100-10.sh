...
MODEL0=checkpoints/step/att_top_25/100-10-ade_MiB_0.pth
...
CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=1 attribute_class.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 1 --lr 0.001 --method ${METHOD} --opt_level O2 ${OPTIONS} #--step_ckpt ${MODEL0}
CUDA_VISIBLE_DEVICES=${GPU} python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=${NB_GPU} run.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 1 --lr 0.001 --epochs ${EPOCHS} --method ${METHOD} --opt_level O1 ${OPTIONS} #--step_ckpt ${MODEL0}
...
CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=1 attribute_class.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 3 --method ${METHOD} --opt_level O2 ${OPTIONS}
...
CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=1 attribute_class.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 4 --method ${METHOD} --opt_level O2 ${OPTIONS}
...
CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=1 attribute_class.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 5 --method ${METHOD} --opt_level O2 ${OPTIONS}
